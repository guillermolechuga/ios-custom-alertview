...
const static CGFloat kCustomIOSAlertViewCornerRadius              = 14;
...
- (UIView *)createContainerView
{
    ...
    dialogContainer.layer.backgroundColor = [UIColor colorWithWhite:1 alpha:0.95f].CGColor;
    ...
    lineView.backgroundColor = [UIColor colorWithWhite:0 alpha:0.07f];
